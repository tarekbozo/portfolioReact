      ...
      <section className='technologes'>
        <div className='content'>
          ...
          <div className="tags-wrapper">
            <span className='content__tag'>React.js</span> <span className='content__tag'>Node.js</span> <span className='content__tag'>JavaScript</span> <span className='content__tag'>styled components</span>
          </div>
        </div>
        ...
        <div className='content'>
          ...
          <p className='content__text'>
            I worked as worldPress Wodget design & Development. 
            PHP Development . 
          </p>
          <div className="tags-wrapper">
            <span className='content__tag'>PHP</span> <span className='content__tag'>CSS</span> <span className='content__tag'>HTML</span> <span className='content__tag'>JavaScript</span> <span className='content__tag'>Sass</span>
          </div>
        </div>
